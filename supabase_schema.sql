...
INSERT INTO suppliers (name, contact_person, phone, address) VALUES
  ('Regasco', 'Sales Desk', '0917-000-1001', 'Main LPG supplier'),
  ('Petron Gasul', 'Sales Desk', '0917-000-1002', 'Main LPG supplier'),
  ('Shellane', 'Sales Desk', '0917-000-1003', 'Main LPG supplier');
...
-- Sample products: LPG Tanks
INSERT INTO products (sku, barcode, name, category_id, unit, cost, price, stock_qty, low_stock_level)
SELECT 'LPG-001', NULL, 'Regasco 11kg LPG Tank - Filled', id, 'tank', 900, 1050, 12, 3 FROM categories WHERE name='LPG Tanks';
INSERT INTO products (sku, barcode, name, category_id, unit, cost, price, stock_qty, low_stock_level)
SELECT 'LPG-002', NULL, 'Regasco 5.5kg LPG Tank - Filled', id, 'tank', 650, 780, 10, 3 FROM categories WHERE name='LPG Tanks';
INSERT INTO products (sku, barcode, name, category_id, unit, cost, price, stock_qty, low_stock_level)
SELECT 'LPG-003', NULL, 'Petron Gasul 11kg LPG Tank - Filled', id, 'tank', 910, 1070, 8, 3 FROM categories WHERE name='LPG Tanks';
INSERT INTO products (sku, barcode, name, category_id, unit, cost, price, stock_qty, low_stock_level)
SELECT 'LPG-004', NULL, 'Shellane 11kg LPG Tank - Filled', id, 'tank', 920, 1080, 8, 3 FROM categories WHERE name='LPG Tanks';
INSERT INTO products (sku, barcode, name, category_id, unit, cost, price, stock_qty, low_stock_level)
SELECT 'LPG-005', NULL, 'Empty LPG Tank Deposit 11kg', id, 'tank', 1200, 1500, 5, 2 FROM categories WHERE name='LPG Tanks';

-- Sample products: LPG Accessories
INSERT INTO products (sku, barcode, name, category_id, unit, cost, price, stock_qty, low_stock_level)
SELECT 'LPG-A01', NULL, 'Regasco LPG Regulator', id, 'pcs', 180, 260, 20, 5 FROM categories WHERE name='LPG Accessories';
INSERT INTO products (sku, barcode, name, category_id, unit, cost, price, stock_qty, low_stock_level)
SELECT 'LPG-A02', NULL, 'LPG Hose 1.5m', id, 'pcs', 70, 120, 30, 10 FROM categories WHERE name='LPG Accessories';
INSERT INTO products (sku, barcode, name, category_id, unit, cost, price, stock_qty, low_stock_level)
