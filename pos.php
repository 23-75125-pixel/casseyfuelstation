  ...
  <div class="pos-left">
    ...
    <div class="card" style="padding:14px">
      <div style="display:flex;align-items:center;gap:10px;margin-bottom:12px;flex-wrap:wrap">
        ...
        <span style="font-weight:700;font-size:14px">Products</span>
  ...
  <div class="pos-right">
    ...
    <div class="cart-items" id="cart-items">
      <div style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;color:var(--text-muted);padding:40px 20px;gap:12px">
        ...
        <div style="font-size:12px;text-align:center">Add fuel, LPG tanks, or other products to start a transaction</div>
      </div>
    </div>
