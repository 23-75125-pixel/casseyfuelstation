...
<div style="display:flex;flex-direction:column;gap:20px">
  <div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap">
    <h1 style="margin:0;font-size:22px;font-weight:800;flex:1">Oil Products</h1>
    <button class="btn btn-primary" onclick="openProductModal()">+ Add Oil Product</button>
  </div>
  <div class="card" style="padding:14px">
    <div style="display:flex;gap:10px;flex-wrap:wrap;align-items:center">
      <input type="text" class="form-control" id="search-input" placeholder="Search oil name, barcode, SKU..." style="max-width:280px" oninput="filterProducts()">
      <select class="form-select" id="cat-filter" style="max-width:180px" onchange="filterProducts()"><option value="">All Oil Categories</option></select>
  ...
  <div class="card">
    <div class="table-wrap">
      <table class="table">
        ...
        <tbody id="products-tbody"><tr><td colspan="8" style="text-align:center;padding:40px;color:var(--text-muted)">Loading oil products...</td></tr></tbody>
      </table>
    </div>
  </div>
</div>
